...
#root -l -b -q 'make_smeared_perfect.C("djangoh.CC.18x275_evt")'
#echo "Done!!!"

#echo "Making Second Smeared ROOT File..."
#root -l -b -q 'make_smeared_central.C("djangoh.CC.18x275_evt")'
#echo "Done!!!"

#echo "Making Third Smeared ROOT File..."
#root -l -b -q 'make_smeared_handbook.C("djangoh.CC.18x275_evt")'
#echo "Done!!!"
