...
void purity_stability(){
  ...
  TH2D *h3_4 = new TH2D("h3_4","JB Method Purity (Summing Over Hadrons)",25,x_bins,25,Q2_bins);
  h3_4->GetXaxis()->SetTitle("x");h3_4->GetXaxis()->CenterTitle();
  h3_4->GetYaxis()->SetTitle("Q^{2} [GeV^{2}]");h3_4->GetYaxis()->CenterTitle();
  TH2D *h3_5 = new TH2D("h3_5","JB Method Stability (Summing Over Hadrons)",25,x_bins,25,Q2_bins);
  h3_5->GetXaxis()->SetTitle("x");h3_5->GetXaxis()->CenterTitle();
  h3_5->GetYaxis()->SetTitle("Q^{2} [GeV^{2}]");h3_5->GetYaxis()->CenterTitle();
  TH2D *h3_6 = new TH2D("h3_6","JB Method Reconstructed (Summing Over Hadrons)",25,x_bins,25,Q2_bins);
  ...
  TH2D *h4_4 = new TH2D("h4_4","DA Method Purity (Summing Over Hadrons)",25,x_bins,25,Q2_bins);
  h4_4->GetXaxis()->SetTitle("x");h4_4->GetXaxis()->CenterTitle();
  h4_4->GetYaxis()->SetTitle("Q^{2} [GeV^{2}]");h4_4->GetYaxis()->CenterTitle();
  TH2D *h4_5 = new TH2D("h4_5","DA Method Stability (Summing Over Hadrons)",25,x_bins,25,Q2_bins);
  h4_5->GetXaxis()->SetTitle("x");h4_5->GetXaxis()->CenterTitle();
  h4_5->GetYaxis()->SetTitle("Q^{2} [GeV^{2}]");h4_5->GetYaxis()->CenterTitle();
  TH2D *h4_6 = new TH2D("h4_6","DA Method Reconstructed (Summing Over Hadrons)",25,x_bins,25,Q2_bins);
  ...
  if(energy_set == 1){
    tex_energy->SetText(20,80,"5 GeV e^{-} on 41 GeV Au, #sqrt{s}=28.6 GeV");
