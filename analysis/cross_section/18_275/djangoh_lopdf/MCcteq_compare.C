...
void MCcteq_compare(){
    ...
    for(int i=0;i<10;i++){
        t_d->Add(Form("/eic/data/baraks/dis-reconstruction/djangoh/outfiles/yellow/18_275_lo/djangoh.NC.lo.18x275_%d.root",i));
    }
    ...
    double cross_tot_d = 1.68E9; //Total Cross Section in fb
