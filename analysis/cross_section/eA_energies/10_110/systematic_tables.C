...
void systematic_tables(){
    ...
    for(int i=0;i<15;i++){
        t->Add(Form("/eic/data/baraks/pythiaeRHIC/outfiles/yellow_report/10_110/ep_10_110_newtune_%d.root",i));
    }

    for(int i=0;i<30;i++){
        t->Add(Form("/eic/data/baraks/pythiaeRHIC/outfiles/yellow_report/additional/10_110/ep_10_110_newtune_%d.root",i));
    }
    ...
    double cross_tot = 1.14E9; //Total Cross Section in fb
