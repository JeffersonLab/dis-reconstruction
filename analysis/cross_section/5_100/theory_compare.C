...
void theory_compare(){
    ...
    double cross_tot = 0.926E9; //Total Cross Section in fb
    ...
    for(int i=0;i<10;i++){
        t_d->Add(Form("/eic/data/baraks/dis-reconstruction/djangoh/outfiles/yellow/5_100/djangoh.NC.5x100_%d.root",i));
    }
    ...
    double cross_tot_d = 0.908E9; //Total Cross Section in fb
    ...
    TLatex *tex2 = new TLatex(7E-4,1.6,"5 GeV e^{-} on 100 GeV p, #sqrt{s}=44.7 GeV");
