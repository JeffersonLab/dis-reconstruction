...
void systematic_tables(){
    ...
    for(int i=0;i<=10;i++){
        t->Add(Form("/eic/data/baraks/pythiaeRHIC/outfiles/yellow_report/10_100/ep_10_100_newtune_%d.root",i));
    }

    for(int i=0;i<25;i++){
        t->Add(Form("/eic/data/baraks/pythiaeRHIC/outfiles/yellow_report/additional/10_100/ep_10_100_newtune_%d.root",i));
    }

    for(int i=0;i<25;i++){
        t->Add(Form("/eic/data/baraks/pythiaeRHIC/outfiles/yellow_report/additional2/10_100/ep_10_100_newtune_%d.root",i));
    }
    ...
    double cross_tot = 1.11E9; //Total Cross Section in fb
